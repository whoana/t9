...
public class OldStateCheckHandler implements StateCheckHandler{
	...
	public void checkAndSet(boolean first, Trace trace, State state) {
		...
		int    recordCount     = Integer.parseInt(trace.getRecordCount()); 
		int    dataAmount      = Integer.parseInt(trace.getDataSize());
