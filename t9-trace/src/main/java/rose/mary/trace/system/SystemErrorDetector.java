...
public class SystemErrorDetector {
	 ...
	 * @param exception
	 */
//	@AfterThrowing(pointcut = "execution(public * rose.mary.trace.database.service.*Service.*())", throwing = "exception")
//	@AfterThrowing(pointcut = "execution(public * rose.mary.trace.database.service.*Service.*())", throwing = "exception")
...
//	retry-trace.log:org.infinispan.commons.CacheException: java.lang.OutOfMemoryError: Java heap space
//	
//	rosemary_19-05-2020_0.log
//	
//	
//	rosemary_15-05-2020_0.log:org.apache.ibatis.exceptions.PersistenceException: 
//	rosemary_15-05-2020_0.log:### Error flushing statements.  Cause: org.apache.ibatis.executor.BatchExecutorException: rose.mary.trace.database.mapper.m01.TraceMapper.insert (batch index #1) failed. Cause: java.sql.BatchUpdateException: ORA-01653: IIPDMC.TOP0501 테이블을 8192(으)로 IIPDMC_DAT_TBS 테이블스페이스에서 확장할 수 없습니다
//	rosemary_15-05-2020_0.log:### Cause: org.apache.ibatis.executor.BatchExecutorException: rose.mary.trace.database.mapper.m01.TraceMapper
//		
//	rosemary_19-05-2020_0.log:org.apache.ibatis.exceptions.PersistenceException: 
//		rosemary_19-05-2020_0.log:### Error flushing statements.  Cause: org.apache.ibatis.executor.BatchExecutorException: rose.mary.trace.database.mapper.m01.TraceMapper.insert (batch index #1) failed. Cause: java.sql.BatchUpdateException: ORA-01654: IIPDMC.PK_TOP0501 인덱스를 8192(으)로 IIPDMC_DAT_TBS 테이블스페이스에서 확장할 수 없습니다
//		
//	
//	rosemary_30-04-2020_0.log:org.apache.ibatis.exceptions.PersistenceException: 
//	rosemary_30-04-2020_0.log:### Error querying database.  Cause: org.springframework.jdbc.CannotGetJdbcConnectionException: Failed to obtain JDBC Connection; nested exception is java.sql.SQLTransientConnectionException: HikariPool-2 - Connection is not available, request timed out after 30000ms.
//	
	...
	//### Error querying database.  Cause: org.springframework.jdbc.CannotGetJdbcConnectionException: Failed to obtain JDBC Connection; nested exception is java.sql.SQLException: HikariDataSource HikariDat
