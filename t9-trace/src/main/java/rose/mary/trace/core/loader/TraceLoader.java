 ...
 */
package rose.mary.trace.core.loader;
...
public class TraceLoader implements Runnable{
	...
	public TraceLoader(String name, int commitCount, long delayForNoMessage, boolean loadError, boolean loadContents, CacheProxy<String, Trace> distributeCache, CacheProxy<String, Trace> mergeCache, CacheProxy<String, Trace> errorCache, TraceService traceLoadService, ThroughputMonitor tpm, ExceptionHandler exceptionHandler) {
		this.name = name;
