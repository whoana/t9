...
// @MapperScan(value="reose.mary.trace.database.mapper.m01",
...
public class DataSource01Config {
	...
	public SqlSessionTemplate sqlSession(
			@Autowired @Qualifier("sqlSessionFactory01") SqlSessionFactory sqlSessionFactory) {
	...
	public DataSourceTransactionManager transactionManager(
			@Autowired @Qualifier("datasource01") DataSource dataSource) {
