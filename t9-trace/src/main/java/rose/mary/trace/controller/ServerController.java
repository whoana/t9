...
public class ServerController {
	...
	@RequestMapping(value = "/trace/console/servers/testers/start", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/trace/console/servers/testers/stop", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/trace/console/servers/generate/msgs/{number}", method = RequestMethod.GET)
	...
	public @ResponseBody Map<String, Object> getCacheDataCount(HttpSession httpSession, Locale locale,
			HttpServletRequest request) throws Throwable {
		Map<String, Object> res = new HashMap<String, Object>();
		try {
			...
			String msg = "{" + dcMsg.toString() + "," + mcMsg.toString() + "," + bcMsg.toString() + ","
					+ fcMsg.toString() + "}";
			res.put("msg", msg);
	...
	public @ResponseBody Map<String, Object> shutdown(HttpSession httpSession, Locale locale,
			HttpServletRequest request) throws Throwable {
		Map<String, Object> res = new HashMap<String, Object>();
		try {
	...
	public @ResponseBody Map<String, Object> startServerGet(HttpSession httpSession, Locale locale,
			HttpServletRequest request) throws Throwable {
		Map<String, Object> res = new HashMap<String, Object>();
		try {
	...
	@RequestMapping(value = "/trace/console/servers/stop", method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> stopServerGet(HttpSession httpSession, Locale locale,
			HttpServletRequest request) throws Throwable {
		Map<String, Object> res = new HashMap<String, Object>();
		try {
	...
	@RequestMapping(value = "/trace/managers/servers/trace-error-handler/start", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/trace-error-handler/stop", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/finisher/start", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/finisher/stop", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/botLoader/start", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/botLoader/stop", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/boter/stop", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/loader/start", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/loader/stop", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/channel/start", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/servers/channel/stop", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@Async
	@RequestMapping(value = "/trace/managers/servers/shutdown", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
