...
public class InterfaceInfo implements Serializable {
	...
	public void setRecvOrgCd(String recvOrgCd) {
		this.recvOrgCd = recvOrgCd;
	}

	public String getRecvOrgCd() {
		return recvOrgCd;
	}
	...
	public void setRecvSystemCd(String recvSystemCd) {
		this.recvSystemCd = recvSystemCd;
	}

	public String getRecvSystemCd() {
		return recvSystemCd;
	}
